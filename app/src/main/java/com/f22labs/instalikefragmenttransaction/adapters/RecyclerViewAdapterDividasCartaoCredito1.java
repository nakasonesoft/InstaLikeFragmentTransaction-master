...
public class RecyclerViewAdapterDividasCartaoCredito1 extends RecyclerView.Adapter<RecyclerViewAdapterDividasCartaoCredito1.ViewHolder>
{
    ...
    Object mContext;
    public RecyclerViewAdapterDividasCartaoCredito1(List<GetDataAdapter> getDataAdapter, Activity context){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_items_dividas_cartao_credito1, parent, false);
