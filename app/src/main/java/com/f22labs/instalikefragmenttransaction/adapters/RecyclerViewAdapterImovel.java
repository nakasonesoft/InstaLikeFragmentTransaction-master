...
public class RecyclerViewAdapterImovel extends RecyclerView.Adapter<RecyclerViewAdapterImovel.ViewHolder>
{
    ...
    public void onBindViewHolder(final ViewHolder Viewholder, final int position)
    {
        ...
        jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+getDataAdapter1.getComofoipago_prestImovel(),
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response)
                    {
                        ...
                        try
                        {
                            ...
                            Log.d("NOME",nome);
                            Viewholder.comofoipago_prestImovel.setText(nome);
