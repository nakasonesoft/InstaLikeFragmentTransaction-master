...
public class RecyclerViewAdapterFicha extends RecyclerView.Adapter<RecyclerViewAdapterFicha.ViewHolder>
{
    ...
    public RecyclerViewAdapterFicha(List<GetDataAdapter> getDataAdapter, Activity context){
