...
public class DataParser2 extends AsyncTask<Void,Void,Integer> {
   ...
   public static ArrayList<String> itemsa=new ArrayList<>();
    ...
    public DataParser2(Context c, GridView gv, String jsonData) {
        this.c = c;
        this.gv = gv;
    ...
    private int parseData()
    {
        try {
            ...
            for(int i=0;i<ja.length();i++)
            {
                switch (i)
                {
                    case 0: spacecrafts.add("Água"); break;
                    case 1: spacecrafts.add("Alimentação e Outras Despesas do Lar"); break;
                    case 2: spacecrafts.add("Aluguel, despesa"); break;
                    case 3: spacecrafts.add("Condução"); break;
                    case 4: spacecrafts.add("Cuidado Pessoal"); break;
                    case 5: spacecrafts.add("Despesas com Telefone e Celular"); break;
                    case 6: spacecrafts.add("Luz"); break;
                    case 7: spacecrafts.add("Mesada, despesa"); break;
                    case 8: spacecrafts.add("Outras Despesas financeiras"); break;
                    case 9: spacecrafts.add("Saúde"); break;
                    case 10: spacecrafts.add("Vestuário e Acessórios"); break;
                    case 11: spacecrafts.add("Despesas Diversas"); break;
                    case 12: spacecrafts.add("Juros, etc, Cartões de Crédito"); break;
                    case 13: spacecrafts.add("Juros e IOF Cheque Especial"); break;
                    case 14: spacecrafts.add("Despesas Supérfluas"); break;
               ...
               if(contagem ==0 && i == 1)
                ...
                if(i == 14){spacecrafts.add("Total Geral: "); spacecrafts.add("R$ " + String.valueOf(soma));contagem++;}
